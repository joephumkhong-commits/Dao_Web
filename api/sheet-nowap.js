...
const TAB = 'Commandes sans WhatsApp';
const RANGE = `${TAB}!A:I`;
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Colonnes : Date | Prénom | Nom | Email | Tel | Animal | Signe | Chiffre | Message
    const { date, prenom, nom, email, tel, animal, signe, chiffre, message } = req.body || {};
